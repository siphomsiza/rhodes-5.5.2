...
//methods
    ...
    virtual void setPollInterval( int pollInterval, rho::apiGenerator::CMethodResult& oResult) = 0;
    virtual void getSyncServer(rho::apiGenerator::CMethodResult& oResult) = 0;
    virtual void setSyncServer( const rho::String& syncServer, rho::apiGenerator::CMethodResult& oResult) = 0;
    virtual void getBulksyncState(rho::apiGenerator::CMethodResult& oResult) = 0;
    virtual void setBulksyncState( int bulksyncState, rho::apiGenerator::CMethodResult& oResult) = 0;
    virtual void getPageSize(rho::apiGenerator::CMethodResult& oResult) = 0;
    virtual void setPageSize( int pageSize, rho::apiGenerator::CMethodResult& oResult) = 0;
    virtual void getThreadedMode(rho::apiGenerator::CMethodResult& oResult) = 0;
    virtual void setThreadedMode( bool threadedMode, rho::apiGenerator::CMethodResult& oResult) = 0;
    virtual void getShowStatusPopup(rho::apiGenerator::CMethodResult& oResult) = 0;
    virtual void setShowStatusPopup( bool showStatusPopup, rho::apiGenerator::CMethodResult& oResult) = 0;
    virtual void getSslVerifyPeer(rho::apiGenerator::CMethodResult& oResult) = 0;
    virtual void setSslVerifyPeer( bool sslVerifyPeer, rho::apiGenerator::CMethodResult& oResult) = 0;
    virtual void isLoggedIn(rho::apiGenerator::CMethodResult& oResult) = 0;
