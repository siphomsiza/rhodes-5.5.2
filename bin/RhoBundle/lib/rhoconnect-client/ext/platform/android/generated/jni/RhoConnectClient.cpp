...
const char* const CRhoConnectClientBase::GETBULKSYNCSTATE_TASK_CLASS = 
        "com.rho.rhoconnectclient.RhoConnectClientSingletonBase$getBulksyncStateTask";

jclass CRhoConnectClientBase::s_clsgetBulksyncStateTask = 0;
jmethodID CRhoConnectClientBase::s_midgetBulksyncStateTask;

const char* const CRhoConnectClientBase::SETBULKSYNCSTATE_TASK_CLASS = 
        "com.rho.rhoconnectclient.RhoConnectClientSingletonBase$setBulksyncStateTask";

jclass CRhoConnectClientBase::s_clssetBulksyncStateTask = 0;
jmethodID CRhoConnectClientBase::s_midsetBulksyncStateTask;
...
const char* const CRhoConnectClientBase::ISLOGGEDIN_TASK_CLASS = 
        "com.rho.rhoconnectclient.RhoConnectClientSingletonBase$isLoggedInTask";

jclass CRhoConnectClientBase::s_clsisLoggedInTask = 0;
jmethodID CRhoConnectClientBase::s_midisLoggedInTask;

const char* const CRhoConnectClientBase::ISSYNCING_TASK_CLASS = 
        "com.rho.rhoconnectclient.RhoConnectClientSingletonBase$isSyncingTask";

jclass CRhoConnectClientBase::s_clsisSyncingTask = 0;
jmethodID CRhoConnectClientBase::s_midisSyncingTask;
...
JNIEnv* CRhoConnectClientBase::jniInit(JNIEnv* env)
{
    ...
    if(!initialized)
    {
        ...
        s_clsgetBulksyncStateTask = loadClass(env, GETBULKSYNCSTATE_TASK_CLASS);
        if (!s_clsgetBulksyncStateTask) return 0;
        s_midgetBulksyncStateTask = env->GetMethodID(s_clsgetBulksyncStateTask, "<init>",
                        "(Lcom/rho/rhoconnectclient/IRhoConnectClientSingleton;Lcom/rhomobile/rhodes/api/IMethodResult;)V");
        if(!s_midgetBulksyncStateTask)
        {
            LOG(FATAL) + "Failed to get constructor for java class " + GETBULKSYNCSTATE_TASK_CLASS;
            return NULL;
        }

        s_clssetBulksyncStateTask = loadClass(env, SETBULKSYNCSTATE_TASK_CLASS);
        if (!s_clssetBulksyncStateTask) return 0;
        s_midsetBulksyncStateTask = env->GetMethodID(s_clssetBulksyncStateTask, "<init>",
                        "(Lcom/rho/rhoconnectclient/IRhoConnectClientSingleton;ILcom/rhomobile/rhodes/api/IMethodResult;)V");
        if(!s_midsetBulksyncStateTask)
        {
            LOG(FATAL) + "Failed to get constructor for java class " + SETBULKSYNCSTATE_TASK_CLASS;
            return NULL;
        }
        ...
        s_clsisLoggedInTask = loadClass(env, ISLOGGEDIN_TASK_CLASS);
        if (!s_clsisLoggedInTask) return 0;
        s_midisLoggedInTask = env->GetMethodID(s_clsisLoggedInTask, "<init>",
                        "(Lcom/rho/rhoconnectclient/IRhoConnectClientSingleton;Lcom/rhomobile/rhodes/api/IMethodResult;)V");
        if(!s_midisLoggedInTask)
        {
            LOG(FATAL) + "Failed to get constructor for java class " + ISLOGGEDIN_TASK_CLASS;
            return NULL;
        }

        s_clsisSyncingTask = loadClass(env, ISSYNCING_TASK_CLASS);
        if (!s_clsisSyncingTask) return 0;
        s_midisSyncingTask = env->GetMethodID(s_clsisSyncingTask, "<init>",
                        "(Lcom/rho/rhoconnectclient/IRhoConnectClientSingleton;Lcom/rhomobile/rhodes/api/IMethodResult;)V");
        if(!s_midisSyncingTask)
        {
            LOG(FATAL) + "Failed to get constructor for java class " + ISSYNCING_TASK_CLASS;
            return NULL;
        }
